...
const CustomerReviews = () => {
    ...
    return(
        <div style={{padding:"50px 0px"}} className="center aligned" >
            ...
            {  !lessThan540 &&
        <div className="ui four columns grid center aligned">
        {displayReviews('')}
...

        {
            ...
            <div style={{width:"90%", margin:"0 auto", textAlign:"center"}}>
             {displayReviews('reviewSlider')}{setSlider('reviewSlider')} 
             <i className="left arrow icon" onClick={()=>{plusSlides(-1,'reviewSlider')}}></i>
             <i className="right arrow icon" onClick={()=>{plusSlides(1,'reviewSlider')}}></i>
